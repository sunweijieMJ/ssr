    ...
    data() {
      return {
        msg: [
          {
            title: '配送范围和时间',
            content: ['下单付款后，瓴里艺术品服务专员将立即联系您安排相应的配送服务，配送范围包含大陆以及香港地区，由专业服务公司实施运输和安装或挂放。']
          },
          {
            title: '付款方式',
          ...
          {
            title: '收货流程',
            content: ['请您在收货时，仔细检查您所购买的产品，确认艺术品数量、实物及画廊提供的艺术品证书是否与所订购的相符，如不符请立即联系瓴里艺术品服务专员或客服热线。']
          },
          {
            title: '售后服务',
            content: ['售后问题请联系客服热线400-819-0101']
          },
          {
            title: '艺术品保养',
            content: ['请放置在干燥通风处，避免阳光直射，且避免重压。']
          },
          {
            title: 'FAQ服务条款',
            question: [
