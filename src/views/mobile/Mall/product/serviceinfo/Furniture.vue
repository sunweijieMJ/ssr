        ...
        msg: [
          {
            ...
            table: [
              ['类型', '配送范围', '配送时间'],
              ['小件家具', '大陆地区顺丰包邮。（港澳台、海外地区暂不派送） 超出配送区域的，免费发至最近的服务网点，客户自行提货。', '下单付款后，24小时内发货（预售商品、双11/618等促销期间商品以及详情页有特别标注发货时间的商品除外） 送达时效以顺丰快递实际配送为准。'],
          ...
          },
          {
            ...
            content: [
              {
                h2: '在大件家具送装前, 我们可以为您提供免费上门勘察服务，主要包括车辆通行、入户条件、家具室内摆放位置、保护准备等。请您在收货时，仔细检查一下您所购买的产品，注意请在运输人员在场的情况下确认：',
                p: [
                  ...
                  '7. 安装完成后进行现场清洁整理。',
                  '8. 商品交付后代为保管商品包装 30 天，以备您发生退换货时使用。'
                ]
              }
            ]
          },
          {
            ...
            content: [
              {
                h2: '在订购完商品后，瓴里提供最长 60 天免费仓储服务，若超 60 天后按每件商品 20 元/天收取费用。'
              }
            ]
          },
          {
            ...
            content: [
              {
                h2: '自下单起 15 天内，若主站／App 上的产品价格出现折扣或有其他形式的促销活动，可以申请价格保护；每张订单可以享受一次价格保护，可联系客服提出申请。 折扣差价及活动差价将以无限期全场优惠券的形式，返还到账户，可在购买时抵用。指定渠道的特殊活动（如门店独享、推广活动等），不在主站／App价格保护政策范围之内。'
              }
            ]
          },
          {
            ...
            content: [
              {
                h2: '瓴里承诺 100% 准时发货， 但若有紧急情况导致发货日期必须延迟， 为客户的损失以积分形式按每日订单金额千分之一发放到用户账户上，最高返还逾期产品金额 10% 的积分，积分会次日发放。'
              }
            ]
          },
          {
            ...
            content: [
              {
                h1: '质保为期一年，首年免费。三包服务以产品实际签收日期为起始日。 质保期内，产品在正常使用和维护的情况下出现问题，经检测若属于产品质量问题，将提供免费维修服务，直至问题解决。'
              },
              {
                h1: '商品退换 ,“三包”质保服务范围内，若产品在正常使用过程中出现质量问题，我们将按照以下标准解决问题：',
                p: [
                  '1. 维修：在“三包”期限内，产品出现质量问题，瓴里将负责免费维修；',
                  '2. 更换：在“三包”期限内，若同一问题经两次维修后仍未能解决，我们将更换产品；',
                  '3. 退货：在“三包”期限内， 同一产品经两次更换后，仍无法达到质量标准的，您可以选择更换其他同类产品或退货。'
                ]
              },
              {
                h1: '以下几种情况不属于三包范围：',
