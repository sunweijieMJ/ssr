<template>
  <div class="download">
    ...
    <img v-if="phone_model === 'iPhone'" src="../../../../static/mobile/icon/download_qr_ios.png" alt="二维码下载">
    <img v-if="(phone_model === 'Android') || (phone_model !== 'iPhone')" src="../../../../static/mobile/icon/download_qr_android.png" alt="二维码下载">
