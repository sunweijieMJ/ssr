      ...
      image_text: [
        {
          ...
          content: [
            {
              desc: ['“瓴”出自“高屋建瓴”，代表高品质家生活，饱含着人们对圆满生活的憧憬与希望。']
            },
            {
              desc: ['瓴里始终如一的坚持设计驱动，提供全球化、场景化、系列化的生活方式提案，将健康、积极向上的人生态度传播给对品质生活有向往的人们。']
            }
          ],
          btn: true,
          btn_text: '了解瓴里',
        ...
        },
        {
          ...
          content: [
            ...
            {
              desc: ['以简约、现代、艺术的设计感，追求匠心工艺的品质感感为产品研发基准，为人们带来愉悦的使用体验和生活方式。']
            }
          ],
          btn: true,
          btn_text: '更多产品',
          ...
          content: [
            {
              desc: [
                ...
                '以简约、现代、艺术的设计感，追求匠心工艺的品质感感为产品研发基准，',
                '为人们带来愉悦的使用体验和生活方式。'
              ]
            }
          ],
