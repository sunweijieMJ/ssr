import web_join_img_banner from '../../../static/web/img/banner.png';
import web_join_img_01 from '../../../static/web/img/join_img_01.png';
  ...
  state: () => ({
    ...
    web: {
      ...
      table: [
        ...
        {first: 'Senior Art Designer', second: 'Public Relations Supervisor', third: '包装采购经理'},
        {first: 'QC 主管', second: '社区产品经理', third: '用户运营经理'},
